let numMegaSena = []//array criada para o seu numero escolhido ou sorteado
let gabarito = [40, 20, 56, 4, 37, 16]//gabrito pé oficial, criado para facilitar a resposta para numero aleatorio
let resultado = []//comparação de resultados
